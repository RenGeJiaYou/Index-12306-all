package com.sjj.distributedidspringbootstarter.handler;

import com.sjj.distributedidspringbootstarter.core.IdGenerator;
import com.sjj.distributedidspringbootstarter.core.serviceid.DefaultServiceIdGenerator;
import com.sjj.distributedidspringbootstarter.core.serviceid.ServiceIdGenerator;
...
public class IdGeneratorManager {
    ...
    public static ServiceIdGenerator getIdGenerator(@NonNull String resource) {
        return Optional.
                ...
                .map(each -> (ServiceIdGenerator) each)
                .orElse(null);
    }
    ...
    public static ServiceIdGenerator getDefaultIdGenerator() {
        return (ServiceIdGenerator) Optional.
                ofNullable(MANAGER.get("default")).orElse(null);
    }
}
